...
public class GeofenceTransitionService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		System.out.println("GeofenceTransitionService.onHandleIntent(...) launched");
		if (intent != null) {
			...
			case Geofence.GEOFENCE_TRANSITION_DWELL:
				...
				//This 'if' statement may be unnecessary:  check if user is inside geofence area
				if(canCheckIn() == true){
					//TODO: some code to run when to signify the user is still within the geofence area
					//TODO: create a notification to send to user when this transition happens
					break;
				}
				break;
			case Geofence.GEOFENCE_TRANSITION_ENTER:
				...
				//set checkIn = true which will allow the 'Check In' Button in sessionDeatilActivity to do an action
				//TODO: allow this to set the Check in button from invisible to visible
				//TODO: create a notification to send to user when this transition happens
				checkIn = true;
				break;
			...
			default:
				...
				//TODO: create code to determine the error that sent this intent and launch a proper response
				checkIn = false;
				break;
			}
